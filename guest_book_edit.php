    ...
    <div class="container">
      <div class="row justify-content-center mt-4">
        <div class="col-6">
          ...
          <form method="POST" action="guest_book_update.php?guest_position=<?= $guest_position;?>" enctype="multipart/form-data" class="mt-3">
            <div class="mb-3 row">
              <label for="inpufull_Name" class="col-md-2 col-form-label">Full Name:</label>
              <div class="col-md-10">
                <input type="text" class="form-control" id="inpufull_Name" name="full_name" value="<?= $guest['full_name'];?>">
              </div>
            </div>
            ...
            <div class="col-md-10">
                <textarea type="text" class="form-control" id="comment" name="comment" row ="4"> <?= $guest['comment'];?> </textarea> 
              </div>
            </div>
